        ...
        >
            ...
            <div className="glass rounded-2xl p-6 sm:p-8 border border-primary-200/50 dark:border-primary-800/50 shadow-xl hover:shadow-2xl hover:shadow-primary-500/10 transition-all duration-300">
                <p className="mb-4 text-left">
                    With a foundation in Ethnology and a Master's in Digital Humanities from UCL, I bring a <span className="font-semibold gradient-text-vibrant">multidisciplinary perspective</span> that combines cultural understanding with technical precision. Currently completing my Computer Systems Technology Diploma (Cloud Computing Option) at BCIT, I specialize in software development, automation, and cloud-based system optimization.
                </p>
                <p className="mb-4 text-left">
                    I enjoy coding because it challenges me to think creatively while solving real-world problems. My core languages are <span className="font-medium gradient-text-primary">Python, JavaScript</span>, and <span className="font-medium gradient-text-primary">SQL</span>, and I'm experienced with <span className="font-medium gradient-text-accent">React, Power Platform</span>, and <span className="font-medium gradient-text-accent">SharePoint integration</span>. Through the Cloud Computing program, I've also gained hands-on experience with <span className="font-medium gradient-text-vibrant">AWS services</span> such as <span className="font-medium gradient-text-vibrant">EC2, S3</span>, and <span className="font-medium gradient-text-vibrant">Lambda</span>, focusing on deploying scalable and serverless applications.
                </p>
